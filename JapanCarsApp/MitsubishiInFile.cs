...
{
    public class MitsubishiInFile : CarBase
    {
        private const string fileName = "MitsubishiPrices.txt";
        public MitsubishiInFile(string mark, string model, int yearOfProduction)
